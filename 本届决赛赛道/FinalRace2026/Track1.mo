...
textColor={255,0,0})}), experiment(Algorithm=Dassl,InlineIntegrator=false,InlineStepSize=false,Interval=0.05,StartTime=0,StopTime=240,Tolerance=0.0001),Protection(access=Access.packageDuplicate));
  Vehicle.VehicleBody.Body4DOF4S_TD body3DOF1_1(v_start = 0.8)
...
extent={{-15,-15},{15,15}})));
  ...
  inner Road.TabularRoadObstacle road(
    ...
    obstaclePoint = {{13.7,23,-0.1105},{12.5,37,-0.1105},{5.5,50,-0.1105},{9.5,11.5,-0.1105},{-6.5,38,-0.1105},{-10,2.5,-0.1105},{-39.5,14,-0.1105},{-43.8,40,-0.1105},{-42.7,31,-0.1105}},
    roadWidth = 6.0,
...
extent={{-15,-15},{15,15}})));
  ...
  Real P;
  Real T;
  UGV.ObsAvoidController_Sysblock2 obsAvoidController_Sysblock2_1 
    annotation (Placement(transformation(origin={-141,-44},
extent={{-30.5,-32},{30.5,32}})),__MWORKS(SECInstance=true));
equation
...
thickness=1));
  ...
  annotation(Line(origin={-95,-14},
  points={{-13.7,-46},{9.6,-46},{9.6,45.75},{14.3,45.75}},
  color={0,0,0}));
  end Track1;
