...
extent={{-10,-10},{10,10}})),__MWORKS(BlockSystem(zeroCross=true ,Instance(dynamicSaturation(upperLimit(Type(ref="double") ,Dimension=1) ,u(Type(ref="double") ,Dimension=1) ,lowerLimit(Type(ref="double") ,Dimension=1) ,y(Type(ref="double") ,Dimension=1)) ,u(Type(ref="double") ,Dimension=1) ,y(Type(ref="double") ,Dimension=1) ,constant_up(y(Type(ref="double") ,Dimension=1) ,k(Type(ref="") ,Dimension=1)) ,constant_low(y(Type(ref="double") ,Dimension=1) ,k(Type(ref="") ,Dimension=1)) ,upLimit(Type(ref="") ,Dimension=1) ,lowLimit(Type(ref="") ,Dimension=1)),SampleTime(group="D1")=0.05)));
  ...
  extent={{-40,-30},{40,30}})),__MWORKS(BlockSystem(StateMachine)));
      ...
      textStyle={TextStyle.Bold},
      textColor={74,84,154},
      horizontalAlignment=TextAlignment.Left), __MWORKS(BlockSystem(StateMachine(outerTransition = true))), displayText ="[df > safeF]");
    end State;
    block State2 "状态"
  ...
  points={{-40,22},{40,22}}))}),Protection(access=Access.packageDuplicate));
      ...
      equation
        ...
        points={{-49.8096,-55.981},{102.705,3.0857}},
        color={113,119,170},
        smooth=Smooth.Bezier),Text(origin={0,0},
        lineColor={74,84,154},
        extent={{0,-3},{0,3}},
        ...
        textStyle={TextStyle.Bold},
        textColor={74,84,154},
        horizontalAlignment=TextAlignment.Left), __MWORKS(BlockSystem(StateMachine(outerTransition = true))), displayText ="[after(0.05,sec)]");
      end State1;
...
horizontalAlignment=TextAlignment.Left), __MWORKS(BlockSystem(StateMachine(outerTransition=true))), displayText = "[dr > dl]");
        ...
        textStyle={TextStyle.Bold},
        textColor={74,84,154},
        horizontalAlignment=TextAlignment.Left), __MWORKS(BlockSystem(StateMachine(outerTransition = true))), displayText ="[after(3,sec)]");
      end State2;
    equation
      ...
      points={{0.0362665,14.1629},{-7.7893e-5,1.08246},{0.0362665,-11.0189}},
      color={113,119,170},
