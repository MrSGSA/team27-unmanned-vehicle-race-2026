...
:5,"logical_operator"
:"logical"}}, Sim_seting = {"sim_seting":{"output":"C:\\Users\\admin\\Documents\\MWORKS\\Simulation"}}),version="26.3.0"),Icon(coordinateSystem(extent={{-100,-100},{100,100}},
...
grid={2,2})));
  SubSystem1 raspberry_SetMsg annotation(Placement(transformation(origin={40,45.2},
extent={{-43,-56},{43,56}})),__MWORKS(ComponentNamePlacement(BOTTOM),PortLabels(labelType="SignalName",labels(label(text="u1",instance="u1"),label(text="u2",instance="u2"),label(text="u3",instance="u3"),label(text="u4",instance="u4"),label(text="u5",instance="u5")))));
  SysplorerEmbeddedCoder.Port.Inport speed 
    annotation (Placement(transformation(origin={-58,90},
extent={{-10,-10},{10,10}}),
...
extent={{-1.8,-1.8},{1.8,1.8}})),__MWORKS(BlockSystem(Type(ref="double"),Dimension=1,SampleTime(group="D1")=0.05)));
  SysplorerEmbeddedCoder.Port.Inport gap 
    annotation (Placement(transformation(origin={-58,67.6},
extent={{-10,-10},{10,10}}),
iconTransformation(origin={-101.8,40},
extent={{-1.8,-1.8},{1.8,1.8}})),__MWORKS(BlockSystem(Type(ref="double"),Dimension=1,SampleTime(group="D1")=0.05)));
  SysplorerEmbeddedCoder.Port.Inport steer 
    annotation (Placement(transformation(origin={-58,45.2},
extent={{-10,-10},{10,10}}),
iconTransformation(origin={-101.8,0},
extent={{-1.8,-1.8},{1.8,1.8}})),__MWORKS(BlockSystem(Type(ref="double"),Dimension=1,SampleTime(group="D1")=0.05)));
  SysplorerEmbeddedCoder.Port.Inport front_sensor_steer 
    annotation (Placement(transformation(origin={-58,22.8},
extent={{-10,-10},{10,10}}),
iconTransformation(origin={-101.8,-40},
extent={{-1.8,-1.8},{1.8,1.8}})),__MWORKS(BlockSystem(Type(ref="double"),Dimension=1,SampleTime(group="D1")=0.05)));
  SysplorerEmbeddedCoder.Port.Inport rear_sensor_steer 
    annotation (Placement(transformation(origin={-58,0.4},
extent={{-10,-10},{10,10}}),
iconTransformation(origin={-101.8,-80},
extent={{-1.8,-1.8},{1.8,1.8}})),__MWORKS(BlockSystem(Type(ref="double"),Dimension=1,SampleTime(group="D1")=0.05)));
...
"        );
  ...
  equation
  connect(speed, raspberry_SetMsg.speed) 
  annotation(Line(origin={-25,90},
  points={{-21,0},{20.2,0}},
  color={0,0,0}));
  connect(gap, raspberry_SetMsg.gap) 
  annotation(Line(origin={-25,68},
  points={{-21,-0.4},{20.2,-0.4}},
  color={0,0,0}));
  connect(steer, raspberry_SetMsg.steer) 
  annotation(Line(origin={-25,45},
  points={{-21,0.2},{20.2,0.2}},
  color={0,0,0}));
  connect(front_sensor_steer, raspberry_SetMsg.u4) 
  annotation(Line(origin={-25,23},
  points={{-21,-0.2},{20.2,-0.2}},
  color={0,0,0}));
  connect(rear_sensor_steer, raspberry_SetMsg.u5) 
  annotation(Line(origin={-25,0},
  points={{-21,0.4},{20.2,0.4}},
  color={0,0,0}));
  end Raspberry_SetMsg;