...
extent={{-10,-10},{10,10}})),__MWORKS(BlockSystem(SampleTime(auto=true,group="D1")=0.02,Instance(y(Type(ref="double") ,Dimension=1) ,k(Type(ref="double") ,Dimension=1)))));
  Controller.left left 
    annotation (Placement(transformation(origin={-56.3333,39.91252}, 
...
color={0,0,0}),__MWORKS(BlockSystem(NamedSignal)));
  connect(left.gap, raspberry_SetMsg.gap) 
  annotation(Line(origin={3,38}, 
points={{-11.5333,-21.7149},{71.2,-21.7149},{71.2,14.0211}}, 
color={0,0,0}));
  connect(left.speed, raspberry_SetMsg.speed) 
  annotation(Line(origin={3,50}, 
points={{-11.5333,13.54},{71.2,13.54},{71.2,13.8984}}, 
color={0,0,0}));
  connect(raspberry_GetMsg1.dis1, left.front_dist) 
  annotation(Line(origin={-135,68}, 
  points={{-30.2,0.26548},{30.8667,0.26548}}, 
  color={0,0,0}));
  connect(raspberry_GetMsg1.dis2, left.fl_dist) 
  annotation(Line(origin={-135,54}, 
  points={{-30.2,0.089},{30.8667,0.089}}, 
  color={0,0,0}));
  connect(raspberry_GetMsg1.dis3, left.right_dist) 
  annotation(Line(origin={-135,40}, 
  points={{-30.2,-0.08748},{30.8667,-0.08748}}, 
  color={0,0,0}));
  connect(raspberry_GetMsg1.dis4, left.left_dist) 
  annotation(Line(origin={-135,26}, 
  points={{-30.2,-0.26396},{30.8667,-0.26396}}, 
  color={0,0,0}));
  connect(raspberry_GetMsg1.dis5, left.fr_dist) 
  annotation(Line(origin={-135,12}, 
  points={{-30.2,-0.44044},{30.8667,-0.44044}}, 
  color={0,0,0}));
  connect(left.steer, raspberry_SetMsg.u4) 
  annotation(Line(origin={33,34}, 
points={{-41.5333,5.91252},{-41.5333,-5.73334},{41.2,-5.73334}}, 
color={0,0,0}),__MWORKS(BlockSystem(NamedSignal)));
  connect(left.steer, raspberry_SetMsg.steer) 
  annotation(Line(origin={33,40}, 
  points={{-41.5333,-0.08748},{41.2,-0.08748},{41.2,0.1439}}, 
  color={0,0,0}),__MWORKS(BlockSystem(NamedSignal)));
  end left;