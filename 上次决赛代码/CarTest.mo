...
textString="%name", 
fontSize=14, 
verticalAlignment=TextAlignment.Top)}),experiment(DoublePrecision=false,Algorithm=Euler,InlineIntegrator=false,InlineStepSize=false,Interval=0.05,StartTime=0,StopTime=10,Tolerance=0.0001,IntegratorStep=0.05),Diagram(coordinateSystem(extent={{-100,-100},{100,100}}, 
...
fontName="黑体", 
textStyle={TextStyle.None}, 
textColor={0,85,255}), Rectangle(origin={92,18.0418}, 
fillColor={255,255,255}, 
fillPattern=FillPattern.Solid, 
...
extent={{-33,-35.4412},{33,35.4412}})),__MWORKS(SECInstance=true,ComponentNamePlacement(BOTTOM),BlockSystem(SampleTime(group="")=0)));
  SysplorerEmbeddedCoder.Sources.SineWave sineWave(phase=0,frequency=1,bias=0,amplitude=0.7,timeSource=SysplorerEmbeddedCoder.MathOperation.SineWaveFunction.TimeSourceType.simulationTime) 
...
extent={{-10,-10},{10,10}})),__MWORKS(BlockSystem(SampleTime(auto=false)=0 ,Instance(y(Dimension=1) ,amplitude(Dimension=1) ,bias(Dimension=1) ,frequency(Dimension=1) ,phase(Dimension=1)))));
  SysplorerEmbeddedCoder.Sources.SineWave sineWave1(phase=0,frequency=0.5,bias=0,amplitude=0.8,timeSource=SysplorerEmbeddedCoder.MathOperation.SineWaveFunction.TimeSourceType.simulationTime) 
    annotation (Placement(transformation(origin={-63,-18}, 
extent={{-10,-10},{10,10}})),__MWORKS(BlockSystem(SampleTime(auto=false)=0 ,Instance(y(Dimension=1) ,amplitude(Dimension=1) ,bias(Dimension=1) ,frequency(Dimension=1) ,phase(Dimension=1)))));
  SysplorerEmbeddedCoder.Sources.SineWave sineWave2(phase=0,frequency=0.2,bias=0,amplitude=0.8,timeSource=SysplorerEmbeddedCoder.MathOperation.SineWaveFunction.TimeSourceType.simulationTime) 
    annotation (Placement(transformation(origin={-20.3333,-18}, 
extent={{-10,-10},{10,10}})),__MWORKS(BlockSystem(SampleTime(auto=false)=0 ,Instance(y(Dimension=1) ,amplitude(Dimension=1) ,bias(Dimension=1) ,frequency(Dimension=1) ,phase(Dimension=1)))));
  SysplorerEmbeddedCoder.Sources.PulseGenerator pulseGenerator(phase_time=0,width_time=50,period_time=10,amplitude=10) 
    annotation (Placement(transformation(origin={-58,59.837}, 
extent={{-10,-10},{10,10}})),__MWORKS(BlockSystem(Instance(y(Type(ref="double") ,Dimension=1) ,amplitude(Type(ref="") ,Dimension=1) ,period_time(Dimension=1) ,phase_time(Dimension=1) ,width_time(Dimension=1)),SampleTime(group="D1")=0.05)));
  SysplorerEmbeddedCoder.Sources.Constant constant1(k=0) 
    annotation (Placement(transformation(origin={-58,88}, 
extent={{-10,-10},{10,10}})),__MWORKS(BlockSystem(SampleTime(auto=true,group="D1")=0.05,Instance(y(Type(ref="double") ,Dimension=1) ,k(Type(ref="double") ,Dimension=1)))));
  SysplorerEmbeddedCoder.Sources.Constant constant2(k=-0.1) 
    annotation (Placement(transformation(origin={-94,40.1439}, 
extent={{-10,-10},{10,10}})),__MWORKS(BlockSystem(SampleTime(auto=true,group="D1")=0.05,Instance(y(Type(ref="double") ,Dimension=1) ,k(Type(ref="double") ,Dimension=1)))));
...
"    );
    ...
    extent={{-20,-34.8667},{20,34.8667}})),__MWORKS(BlockSystem(SampleTime(group="D1")=0.05),ComponentNamePlacement(BOTTOM)));
    CCaller c_caller 
      annotation (Placement(transformation(origin={76,132}, 
    extent={{-20,-10},{20,10}})),__MWORKS(BlockSystem(SampleTime(group="D1")=0.05)));
    CCaller1 c_caller1 
    ...
    extent={{-20,-10},{20,10}})),__MWORKS(BlockSystem(SampleTime(group="D1")=0.05)));
    SysplorerEmbeddedCoder.Port.Inport speed 
        annotation ( __MWORKS(BlockSystem(Type(inherit=InheritType.none ,ref="double") ,Dimension(dimensionType=DimensionType.auto)=1,SampleTime(auto=true,group="D1")=0.05)),Placement(transformation(extent = { {40.6, 88.9668}, {47.8, 96.1667}})));
    SysplorerEmbeddedCoder.Port.Inport gap 
        annotation ( __MWORKS(BlockSystem(Type(inherit=InheritType.none ,ref="double") ,Dimension(dimensionType=DimensionType.auto)=1,SampleTime(auto=true,group="D1")=0.05)),Placement(transformation(extent = { {40.6, 54.1}, {47.8, 61.3}})));
    SysplorerEmbeddedCoder.Port.Inport steer 
        annotation ( __MWORKS(BlockSystem(Type(inherit=InheritType.none ,ref="double") ,Dimension(dimensionType=DimensionType.auto)=1,SampleTime(auto=true,group="D1")=0.05)),Placement(transformation(extent = { {40.6, 2.4}, {47.8, 9.6}})));
    SysplorerEmbeddedCoder.Port.Inport u4 
        annotation ( __MWORKS(BlockSystem(Type(inherit=InheritType.none ,ref="double") ,Dimension(dimensionType=DimensionType.auto)=1,SampleTime(auto=true,group="D1")=0.05)),Placement(transformation(extent = { {40.6, -33.6}, {47.8, -26.4}})));
    SysplorerEmbeddedCoder.Port.Inport u5 
        annotation ( __MWORKS(BlockSystem(Type(inherit=InheritType.none ,ref="double") ,Dimension(dimensionType=DimensionType.auto)=1,SampleTime(auto=true,group="D1")=0.05)),Placement(transformation(extent = { {40.6, -79.6}, {47.8, -72.4}})));
  equation
  ...
  equation
  connect(constant1.y, raspberry_SetMsg.speed) 
  annotation(Line(origin={14,76}, 
points={{-60.2,12},{-16,12},{-16,-2},{24,-2},{24,-12.1016},{60.2,-12.1016}}, 
color={0,0,0}));
  connect(constant2.y, raspberry_SetMsg.steer) 
  annotation(Line(origin={-4,40}, 
  points={{-78.2,0.1439},{78.2,0.1439}}, 
  color={0,0,0}));
  end CarTest;