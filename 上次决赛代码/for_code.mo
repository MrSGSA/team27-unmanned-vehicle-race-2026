...
extent={{-33,-29.6931},{33,29.6931}})),__MWORKS(ComponentNamePlacement(BOTTOM),PortLabels(labelType="SignalName",labels(label(text="u1",instance="u1"),label(text="u2",instance="u2"),label(text="u3",instance="u3"),label(text="u5",instance="u5"),label(text="u4",instance="u4")))));
...
extent={{-10,-10},{10,10}})),__MWORKS(BlockSystem(SampleTime(auto=true,group="D1")=0.02,Instance(y(Type(ref="double") ,Dimension=1) ,k(Type(ref="double") ,Dimension=1)))));
  .Unmanned_Vehicle_Race.Controller.ObsAvoidController_Sysblock7g obsAvoidController_Sysblock7g 
    annotation (Placement(transformation(origin={-64,40.2709}, 
