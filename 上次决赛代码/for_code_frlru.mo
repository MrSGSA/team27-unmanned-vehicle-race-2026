...
textString="%name", 
fontSize=14, 
verticalAlignment=TextAlignment.Top)}),experiment(Algorithm=Rkfix4,InlineIntegrator=false,InlineStepSize=false,IntegratorStep=0.05,Interval=0.05,StartTime=0,StopTime=1,Tolerance=0.0001),Diagram(coordinateSystem(extent={{-100,-100},{100,100}}, 
...
extent={{-33,-35.4412},{33,35.4412}})),__MWORKS(SECInstance=true,ComponentNamePlacement(BOTTOM),BlockSystem(SampleTime(group="")=0)));
  SysplorerEmbeddedCoder.Sources.Constant constant1(k=0) 
    annotation (Placement(transformation(origin={-59,-22}, 
extent={{-10,-10},{10,10}})),__MWORKS(BlockSystem(SampleTime(auto=true,group="D1")=0.05,Instance(y(Type(ref="double") ,Dimension=1) ,k(Type(ref="double") ,Dimension=1)))));
  Controller.ObsAvoidController_Sysblock_frlru obsAvoidController_Sysblock_frlru 
    annotation (Placement(transformation(origin={-59,39.91252}, 
extent={{-33,-35.4412},{33,35.4412}})),__MWORKS(SECInstance=true,ComponentNamePlacement(BOTTOM),BlockSystem(SampleTime(group="")=0)));
...
"    );
  ...
  annotation(Line(origin={14,-3}, 
points={{-61.2,-19},{50,-19},{50,19.38942},{60.2,19.38942}}, 
color={0,0,0}));
  connect(raspberry_GetMsg1.dis1, obsAvoidController_Sysblock_frlru.front_dist) 
  annotation(Line(origin={-129,68}, 
  points={{-36.2,0.26548},{35.2,0.26548}}, 
  color={0,0,0}));
  connect(raspberry_GetMsg1.dis2, obsAvoidController_Sysblock_frlru.rear_dist) 
  annotation(Line(origin={-129,54}, 
  points={{-36.2,0.089},{35.2,0.089}}, 
  color={0,0,0}));
  connect(raspberry_GetMsg1.dis3, obsAvoidController_Sysblock_frlru.right_dist) 
  annotation(Line(origin={-129,40}, 
  points={{-36.2,-0.08748},{35.2,-0.08748}}, 
  color={0,0,0}));
  connect(raspberry_GetMsg1.dis4, obsAvoidController_Sysblock_frlru.left_dist) 
  annotation(Line(origin={-129,26}, 
  points={{-36.2,-0.26396},{35.2,-0.26396}}, 
  color={0,0,0}));
  connect(raspberry_GetMsg1.dis5, obsAvoidController_Sysblock_frlru.fu_dist) 
  annotation(Line(origin={-129,12}, 
  points={{-36.2,-0.44044},{35.2,-0.44044}}, 
  color={0,0,0}));
  connect(obsAvoidController_Sysblock_frlru.speed, raspberry_SetMsg.speed) 
  annotation(Line(origin={25,65}, 
points={{-49.2,1.49342},{-31,1.49342},{-31,-1.10162},{49.2,-1.10162}}, 
color={0,0,0}));
  connect(obsAvoidController_Sysblock_frlru.steer, raspberry_SetMsg.steer) 
  annotation(Line(origin={25,44}, 
points={{-49.2,4.77282},{-35,4.77282},{-35,-3.8561},{49.2,-3.8561}}, 
color={0,0,0}));
  connect(obsAvoidController_Sysblock_frlru.gap, raspberry_SetMsg.gap) 
  annotation(Line(origin={25,42}, 
points={{-49.2,-10.9478},{-31,-10.9478},{-31,10.0211},{49.2,10.0211}}, 
color={0,0,0}));
  connect(obsAvoidController_Sysblock_frlru.fu_sensor_cmd, raspberry_SetMsg.u4) 
  annotation(Line(origin={25,21}, 
points={{-49.2,-7.66838},{-27,-7.66838},{-27,7.26666},{49.2,7.26666}}, 
color={0,0,0}));
  end for_code_frlru;