...
extent={{-10,-10},{10,10}})),__MWORKS(BlockSystem(SampleTime(auto=true,group="D1")=0.02,Instance(y(Type(ref="double") ,Dimension=1) ,k(Type(ref="double") ,Dimension=1)))));
  Controller.test2 test2_1 
    annotation (Placement(transformation(origin={-50,40.2709}, 
extent={{-46,-35.4412},{46,35.4412}})),__MWORKS(SECInstance=true,ComponentNamePlacement(BOTTOM),BlockSystem(SampleTime(group="")=0)));
...
color={0,0,0}),__MWORKS(BlockSystem(NamedSignal)));
  connect(raspberry_GetMsg1.dis1, test2_1.front_dist) 
  annotation(Line(origin={13,88}, 
points={{-178.2,-19.7345},{-110.8,-19.7345},{-110.8,-19.3761}}, 
color={0,0,0}));
  connect(raspberry_GetMsg1.dis2, test2_1.fl_dist) 
  annotation(Line(origin={13,69}, 
points={{-178.2,-14.911},{-110.8,-14.911},{-110.8,-14.5526}}, 
color={0,0,0}));
  connect(raspberry_GetMsg1.dis3, test2_1.right_dist) 
  annotation(Line(origin={13,51}, 
points={{-178.2,-11.08748},{-110.8,-11.08748},{-110.8,-10.7291}}, 
color={0,0,0}));
  connect(raspberry_GetMsg1.dis4, test2_1.left_dist) 
  annotation(Line(origin={13,33}, 
points={{-178.2,-7.26396},{-110.8,-7.26396},{-110.8,-6.90557}}, 
color={0,0,0}));
  connect(raspberry_GetMsg1.dis5, test2_1.fr_dist) 
  annotation(Line(origin={13,14}, 
points={{-178.2,-2.44044},{-110.8,-2.44044},{-110.8,-2.08205}}, 
color={0,0,0}));
  connect(test2_1.speed, raspberry_SetMsg.speed) 
  annotation(Line(origin={40,71}, 
points={{-42.2,-7.10162},{34.2,-7.10162}}, 
color={0,0,0}));
  connect(test2_1.steer, raspberry_SetMsg.steer) 
  annotation(Line(origin={40,40}, 
points={{-42.2,0.270913},{34.2,0.270913},{34.2,0.1439}}, 
color={0,0,0}));
  connect(test2_1.gap, raspberry_SetMsg.gap) 
  annotation(Line(origin={40,27}, 
points={{-42.2,-10.3566},{34.2,-10.3566},{34.2,25.0211}}, 
color={0,0,0}));
