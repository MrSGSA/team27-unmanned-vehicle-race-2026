model ObsAvoidController_Sysblock4 "避障控制（Sysblock）初赛版本"
...
extent={{-29,-29},{29,29}})),__MWORKS(ComponentNamePlacement(BOTTOM),BlockSystem(SampleTime(group="D1")=-1),PortLabels(labelType="PortName",labels(label(text="df",instance="df"),label(text="db",instance="db"),label(text="dl",instance="dl"),label(text="dr",instance="dr"),label(text="speed",instance="speed"),label(text="steer",instance="steer")))));
...
extent={{-10,-10},{10,10}})),__MWORKS(BlockSystem(zeroCross=true ,Instance(dynamicSaturation(upperLimit(Type(ref="double") ,Dimension=1) ,u(Type(ref="double") ,Dimension=1) ,lowerLimit(Type(ref="double") ,Dimension=1) ,y(Type(ref="double") ,Dimension=1)) ,u(Type(ref="double") ,Dimension=1) ,y(Type(ref="double") ,Dimension=1) ,constant_up(y(Type(ref="double") ,Dimension=1) ,k(Type(ref="") ,Dimension=1)) ,constant_low(y(Type(ref="double") ,Dimension=1) ,k(Type(ref="") ,Dimension=1)) ,upLimit(Type(ref="") ,Dimension=1) ,lowLimit(Type(ref="") ,Dimension=1)),SampleTime(group="D1")=0.05)));
  ...
  grid={2,2})));
    ...
    State longitudinal 
      annotation (Placement(transformation(origin={-71,-22.5}, 
  extent={{-115,-93.5},{115,93.5}})),__MWORKS(BlockSystem(StateMachine(priority=1))));
    ...
    State2 lateral 
      annotation (Placement(transformation(origin={-70,-278}, 
  extent={{-380,-160},{380,160}})),__MWORKS(BlockSystem(StateMachine(priority=2))));
    ...
    State1 state 
      annotation (Placement(transformation(origin={231,-9}, 
extent={{-151,-89},{151,89}})),__MWORKS(BlockSystem(StateMachine(priority=3))));
    block State "状态"
      annotation (__MWORKS(BlockSystem(blockKind=BlockKind.state,SampleTime(auto = true),State),showDiagram = true,sourceModel=SysplorerEmbeddedCoder.StateMachine.State,independentInstance=true,hide=true), defaultComponentName = "state", 
       ...
       Diagram(coordinateSystem(extent={{-115,-93.5},{115,93.5}}, 
  initialScale=1, 
  grid={2,2}),graphics = {State(origin={0,0}, 
  stateTitle=Text(origin={0,0}, 
  lineColor={74,84,154}, 
  extent={{-113,85.5},{113,93.5}}, 
  textString="%name", 
  fontSize=16, 
  ...
  verticalAlignment=TextAlignment.Top))}),Protection(access=Access.packageDuplicate));
      ...
      State2 cruise 
      annotation(Placement(transformation(origin={-65,19.5}, 
  extent={{-40,-30},{40,30}})),__MWORKS(BlockSystem(StateMachine)));
      State avoid 
        annotation (Placement(transformation(origin={67,19.5}, 
  extent={{-40,-30},{40,30}})),__MWORKS(BlockSystem(StateMachine)));
      block State "状态"
        annotation (__MWORKS(BlockSystem(blockKind=BlockKind.state,SampleTime(auto = true),State),showDiagram = true,sourceModel=SysplorerEmbeddedCoder.StateMachine.State,independentInstance=true,hide=true), defaultComponentName = "state", 
         Icon(coordinateSystem(extent={{-100, -100}, {100, 100}}, 
      ...
      annotation(Line(origin={-70,10.8644}, 
      points={{-26,0},{26,0}}, 
      color={113,119,170}, 
      ...
      transition(avoid, cruise, df > safeF, reset = false) 
      annotation(Line(origin={-70,-9.92344}, 
      points={{26,0},{-26,0}}, 
      color={113,119,170}, 
      smooth=Smooth.Bezier),Text(origin={-11.2993,-6.05966}, 
      lineColor={74,84,154}, 
      extent={{0,-3},{0,3}}, 
      textString="%condition", 
      fontSize=10, 
      textStyle={TextStyle.Bold}, 
      textColor={74,84,154}, 
      horizontalAlignment=TextAlignment.Left), __MWORKS(BlockSystem(StateMachine(outerTransition = true, comment = false))), displayText = "[df > safeF]");
    end State;
    block State2 "状态"
  ...
  points={{-40,22},{40,22}}))}),Protection(access=Access.packageDuplicate));
      ...
      equation
        ...
        annotation(Line(origin={-249.116,-307}, 
        ...
        annotation(Line(origin={-287.705,-280.019}, 
        ...
        annotation(Line(origin={-241,-346.509}, 
        points={{-37,0},{37,0}}, 
        color={113,119,170}, 
        ...
        annotation(Line(origin={-170.1284,-306}, 
        points={{0,28},{0,-28}}, 
        color={113,119,170}, 
        smooth=Smooth.Bezier),Text(origin={2.93159,4.53195}, 
        lineColor={74,84,154}, 
        extent={{0,-3},{0,3}}, 
        textString="%condition", 
        fontSize=10, 
        ...
        annotation(Line(origin={-183.246,-306}, 
        ...
        annotation(Line(origin={-241,-361.194}, 
        points={{37,0},{-37,0}}, 
        color={113,119,170}, 
        ...
        textColor={74,84,154}, 
        horizontalAlignment=TextAlignment.Left), __MWORKS(BlockSystem(StateMachine(outerTransition = true, comment = false))), displayText = "[dr < dl]");
        transition(ini_state, state, after(0.05,sec), reset = false) 
        annotation(Line(origin={-246.5,-255.214}, 
        ...
        textStyle={TextStyle.Bold}, 
        textColor={74,84,154}, 
        horizontalAlignment=TextAlignment.Left), __MWORKS(BlockSystem(StateMachine(outerTransition = true, comment = false))), displayText = "[after(0.05,sec)]");
      end State1;
  ...
  points={{-40,22},{40,22}}))}),Protection(access=Access.packageDuplicate));
        algorithm
        annotation(__MWORKS(BlockSystem(StateMachine(actionKind = ActionKind.entry or ActionKind.during))));  steer := -0.523;
        end State;
        State ini_state 
  ...
  points={{-40,22},{40,22}}))}),Protection(access=Access.packageDuplicate));
      ...
      equation
        transition(state, turn_left, dr > dl, reset = false, priority = 2) 
        annotation(Line(origin={74.5343,-312}, 
        points={{51.5714,22},{-51.5714,-22}}, 
        color={113,119,170}, 
        ...
        textColor={74,84,154}, 
        horizontalAlignment=TextAlignment.Left), __MWORKS(BlockSystem(StateMachine(outerTransition = true, comment = false))), displayText = "[dr > dl]");
        transition(state, turn_right, dl > dr, reset = false) 
        annotation(Line(origin={156.9,-312}, 
        ...
        textColor={74,84,154}, 
        horizontalAlignment=TextAlignment.Left), __MWORKS(BlockSystem(StateMachine(outerTransition = true, comment = false))), displayText = "[dl > dr]");
        transition(turn_left, turn_right, dl > dr, reset = false) 
        annotation(Line(origin={91,-348.57}, 
        points={{-33,0},{33,0}}, 
        color={113,119,170}, 
        ...
        horizontalAlignment=TextAlignment.Left), __MWORKS(BlockSystem(StateMachine(outerTransition = true, comment = false))), displayText = "[dl > dr]");
        transition(turn_right, turn_left, dr > dl, reset = false) 
        annotation(Line(origin={91,-363.574}, 
        points={{33,0},{-33,0}}, 
        color={113,119,170}, 
        ...
        textColor={74,84,154}, 
        horizontalAlignment=TextAlignment.Left), __MWORKS(BlockSystem(StateMachine(outerTransition = true, comment = false))), displayText = "[dr > dl]");
        transition(ini_state, state, after(3,sec), reset = false) 
        annotation(Line(origin={75,-270.492}, 
        points={{-45,0},{45,0}}, 
        color={113,119,170}, 
        ...
        textStyle={TextStyle.Bold}, 
        textColor={74,84,154}, 
        horizontalAlignment=TextAlignment.Left), __MWORKS(BlockSystem(StateMachine(outerTransition = true, comment = false))), displayText = "[after(3,sec)]");
      end State2;
    equation
      transition(avoid_lateral, curise_lateral, not flag, reset = false) 
      annotation(Line(origin={-72.3632,-183.749}, 
      ...
      annotation(Line(origin={-72,-201.0168}, 
    ...
    block State1 "状态"
      annotation (__MWORKS(BlockSystem(blockKind=BlockKind.state, SampleTime(auto = true)),showDiagram = true,sourceModel=SysplorerEmbeddedCoder.StateMachine.State,independentInstance=true,hide=true), defaultComponentName = "state", 
       Icon(coordinateSystem(extent={{-100, -100}, {100, 100}}, 
         ...
         horizontalAlignment = TextAlignment.Left, 
         verticalAlignment = TextAlignment.Top)}), 
       Diagram(coordinateSystem(extent={{-151,-89},{151,89}}, 
initialScale=1, 
grid={2,2}),graphics = {State(origin={0,0}, 
stateTitle=Text(origin={0,0}, 
lineColor={74,84,154}, 
extent={{-149,81},{149,89}}, 
textString="%name", 
fontSize=16, 
textStyle={TextStyle.Bold}, 
textColor={74,84,154}, 
...
points={{-40,22},{40,22}}))}),Protection(access=Access.packageDuplicate));
      ...
      State state 
        annotation (Placement(transformation(origin={-73,25}, 
extent={{-40,-30},{40,30}})),__MWORKS(BlockSystem(StateMachine)));
      State1 state1 
        annotation (Placement(transformation(origin={57,25}, 
extent={{-40,-30},{40,30}})),__MWORKS(BlockSystem(StateMachine)));
      block State1 "状态"
        annotation (__MWORKS(BlockSystem(blockKind=BlockKind.state, SampleTime(auto = true)),showDiagram = true,sourceModel=SysplorerEmbeddedCoder.StateMachine.State,independentInstance=true,hide=true), defaultComponentName = "state", 
         Icon(coordinateSystem(extent={{-100, -100}, {100, 100}}, 
    ...
    equation
      transition(state, state1, df<=mindis, reset = false) 
      annotation(Line(origin={223,16.2657}, 
points={{-25,-7.10543e-15},{25,3.55271e-15}}, 
color={113,119,170}, 
smooth=Smooth.Bezier),Text(origin={-10.7206,4.80578}, 
lineColor={74,84,154}, 
extent={{0,-3},{0,3}}, 
textString="%condition", 
fontSize=10, 
...
horizontalAlignment=TextAlignment.Left), __MWORKS(BlockSystem(StateMachine(outerTransition=true,comment=false))), displayText ="[df<=mindis]");
    ...
    annotation(Line(origin={-331.974,-235.67302}, 
    ...
    annotation(Line(origin={-283.907,-206.981}, 
...
color={0,0,0}));
  end ObsAvoidController_Sysblock4;