...
grid={2,2})));
    ...
    State bisai 
      annotation (Placement(transformation(origin={-490,-110}, 
extent={{-350,-176},{350,176}})),__MWORKS(BlockSystem(StateMachine(priority=1))));
    block State "状态"
      annotation (__MWORKS(BlockSystem(blockKind=BlockKind.state, SampleTime(auto = true)),showDiagram = true,sourceModel=SysplorerEmbeddedCoder.StateMachine.State,independentInstance=true,hide=true), defaultComponentName = "state", 
       ...
       Diagram(coordinateSystem(extent={{-350,-176},{350,176}}, 
  initialScale=1, 
  grid={2,2}),graphics = {State(origin={0,0}, 
  stateTitle=Text(origin={0,0}, 
  lineColor={74,84,154}, 
  extent={{-348,168},{348,176}}, 
  textString="%name", 
  fontSize=16, 
  ...
  points={{-40,22},{40,22}}))}),Protection(access=Access.packageDuplicate));
      ...
      State straight 
        annotation (Placement(transformation(origin={-84,82}, 
extent={{-40,-30},{40,30}})),__MWORKS(BlockSystem(StateMachine)));
      State1 left_curve 
        annotation (Placement(transformation(origin={-212,36}, 
extent={{-40,-30},{40,30}})),__MWORKS(BlockSystem(StateMachine)));
      State2 right_curve 
      annotation(Placement(transformation(origin={52,36}, 
extent={{-40,-30},{40,30}})),__MWORKS(BlockSystem(StateMachine)));
      State3 emergency 
        annotation (Placement(transformation(origin={-86,2}, 
extent={{-40,-30},{40,30}})),__MWORKS(BlockSystem(StateMachine)));
      block State1 "状态"
        annotation (__MWORKS(BlockSystem(blockKind=BlockKind.state,SampleTime(auto = true),State),showDiagram = true,sourceModel=SysplorerEmbeddedCoder.StateMachine.State,independentInstance=true,hide=true), defaultComponentName = "state", 
         Icon(coordinateSystem(extent={{-100, -100}, {100, 100}}, 
    ...
    equation
      transition(straight, left_curve, abs(dr-dl)>15 and dl>dr, reset = false) 
      annotation(Line(origin={-686.24,-4.47269}, 
points={{72.2403,2.27142},{-34.9845,-39.5273}}, 
color={113,119,170}, 
smooth=Smooth.Bezier),Text(origin={-55.7469,-5.22159}, 
lineColor={74,84,154}, 
extent={{0,-3},{0,3}}, 
...
textStyle={TextStyle.Bold}, 
textColor={74,84,154}, 
horizontalAlignment=TextAlignment.Left), __MWORKS(BlockSystem(StateMachine(outerTransition=true,comment=false))), displayText = "[abs(dr-dl)>15 and dl>dr]");
      transition(left_curve, straight, abs(dr-dl)<5 and df>20, reset = false) 
      annotation(Line(origin={-662.042,-19.9579}, 
      points={{-24.014,-24.0421},{48.0421,0.0140285}}, 
      color={113,119,170}, 
      smooth=Smooth.Bezier),Text(origin={5.27843,-7.91764}, 
      lineColor={74,84,154}, 
      extent={{0,-3},{0,3}}, 
      textString="%condition", 
      fontSize=10, 
      textStyle={TextStyle.Bold}, 
      textColor={74,84,154}, 
      horizontalAlignment=TextAlignment.Left), __MWORKS(BlockSystem(StateMachine(outerTransition = true, comment = false))), displayText = "[abs(dr-dl)<5 and df>20]");
      transition(straight, right_curve, abs(dr-dl)>15 and dr>dl, reset = false, priority = 2) 
      annotation(Line(origin={-446.063,-2.13119}, 
points={{-87.9366,-1.39967},{44.6682,-41.8688}}, 
color={113,119,170}, 
smooth=Smooth.Bezier),Text(origin={-55.7469,-5.22159}, 
lineColor={74,84,154}, 
extent={{0,-3},{0,3}}, 
...
textStyle={TextStyle.Bold}, 
textColor={74,84,154}, 
horizontalAlignment=TextAlignment.Left), __MWORKS(BlockSystem(StateMachine(outerTransition=true,comment=false))), displayText = "[abs(dr-dl)>15 and dr>dl]");
      transition(right_curve, straight, abs(dr-dl)<5 and df>20, reset = false) 
      annotation(Line(origin={-482.517,-20.4663}, 
      points={{26.4777,-23.5337},{-51.4834,-1.47198}}, 
      color={113,119,170}, 
      smooth=Smooth.Bezier),Text(origin={-41.7476,-13.436}, 
      lineColor={74,84,154}, 
      extent={{0,-3},{0,3}}, 
      textString="%condition", 
      fontSize=10, 
      ...
      textColor={74,84,154}, 
      horizontalAlignment=TextAlignment.Left), __MWORKS(BlockSystem(StateMachine(outerTransition = true, comment = false))), displayText = "[abs(dr-dl)<5 and df>20]");
      transition(left_curve, emergency, df<10, reset = false, priority = 2) 
      annotation(Line(origin={-661.733,-126.733}, 
      points={{-22.9109,22.7328},{45.7328,0.0890808}}, 
      color={113,119,170}, 
      smooth=Smooth.Bezier),Text(origin={4.91791,8.07943}, 
      lineColor={74,84,154}, 
      extent={{0,-3},{0,3}}, 
      textString="%condition", 
      fontSize=10, 
      textStyle={TextStyle.Bold}, 
      textColor={74,84,154}, 
      horizontalAlignment=TextAlignment.Left), __MWORKS(BlockSystem(StateMachine(outerTransition = true, comment = false))), displayText = "[df<10]");
      transition(right_curve, emergency, df<10, reset = false, priority = 2) 
      annotation(Line(origin={-485.011,-125.989}, 
      points={{26.663,21.9891},{-50.9891,2.33698}}, 
      color={113,119,170}, 
      ...
      textColor={74,84,154}, 
      horizontalAlignment=TextAlignment.Left), __MWORKS(BlockSystem(StateMachine(outerTransition = true, comment = false))), displayText = "[df<10]");
      transition(straight, emergency, df<10 or dl<5 or dr<5, reset = false, priority = 3) 
      annotation(Line(origin={-597.652,-68}, 
      points={{0,10},{0,-10}}, 
      color={113,119,170}, 
      smooth=Smooth.Bezier),Text(origin={-38.2517,7.76857}, 
      lineColor={74,84,154}, 
      extent={{0,-3},{0,3}}, 
      textString="%condition", 
      fontSize=10, 
      textStyle={TextStyle.Bold}, 
      textColor={74,84,154}, 
      horizontalAlignment=TextAlignment.Left), __MWORKS(BlockSystem(StateMachine(outerTransition = true, comment = false))), displayText = "[df<10 or dl<5 or dr<5]");
      transition(emergency, straight, df>20 and dl>10 and dr>10, reset = false) 
      annotation(Line(origin={-554.772,-68}, 
      points={{0,-10},{0,10}}, 
      color={113,119,170}, 
      smooth=Smooth.Bezier),Text(origin={6.56892,1.54563}, 
      lineColor={74,84,154}, 
      extent={{0,-3},{0,3}}, 
      textString="%condition", 
      fontSize=10, 
      textStyle={TextStyle.Bold}, 
      textColor={74,84,154}, 
      horizontalAlignment=TextAlignment.Left), __MWORKS(BlockSystem(StateMachine(outerTransition = true, comment = false))), displayText = "[df>20 and dl>10 and dr>10]");
    end State;
    equation
    initialState(bisai.straight, true, 1) 
    annotation(Line(origin={-590,12}, 
points={{0,10},{0,-10}}, 
color={113,119,170}, 
smooth=Smooth.Bezier),Text(origin={0,0}, 
lineColor={74,84,154}, 
